    ...
    return (
        <main className='mt-54 bg-black text-white pb-20'>
            <section className='flex p-8 gap-x-6  max-sm:flex-col'>
                ...
                <div className='flex gap-y-2 flex-col w-1/2 max-sm:w-full bg-blue-288'>
                        <h1>CONTACT US</h1>
                    <form className='w-full '>
                        <div className="mb-4 border-gray-500 border   p-2 w-full">
                            <label htmlFor="price" className="text-small-semibold block text-gray-400 font-bold mb-2 ">Email (required): </label>
                            <input type="number" id="price" name='price' className="border-neutral-500 border  bg-neutral-900 p-2 w-full text-white" />
                        </div>

                        <div className="mb-4 border-gray-500 border   p-2 w-full">
                            <label htmlFor="color" className="text-small-semibold block text-gray-400 font-bold mb-2 ">Name (required): </label>
